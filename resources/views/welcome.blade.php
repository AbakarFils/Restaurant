...
<html lang="en">
        ...
        <script>
            function initialize() {
                ...
                var marker = new google.maps.Marker({
                    ...
                    title:"Abakar'Fils Kitchen Restaurant"
                });
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="Food-fair-toggle">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#menu-list">Les Prix</a></li>
                        <li><a href="#menu-lists">Les Prix favorable</a></li>
                        <li><a href="#great-place-to-enjoy">beer</a></li>
                        <li><a href="#breakfast">Pain</a></li>
                        <li><a href="#featured-dish">En vedette</a></li>
                    ...
                    <div class="row dis-table">
                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                <h2 class="section-content-title">A  propos de nous </h2>
                                <p class="section-content-para">
                                    L'astronomie oblige l'âme à regarder vers le haut et nous conduit de ce monde à l'autre. Curieux que nous passions plus de temps à féliciter les gens qui ont réussi que d'encourager ceux qui ne l'ont pas fait. À mesure que nous nous éloignions de plus en plus, la [Terre] diminuait en taille.                              </p>
                                <p class="section-content-para">
                                    beau, chaud, objet vivant avait l'air si fragile, si délicat, que si vous l'avez touché avec un doigt, il s'écroulerait et tomberait en morceaux. Voyant cela doit changer un homme. Là où se cache l'ignorance, les frontières de la découverte et de l'imagination se cache aussi aussi.                                </p>
                            </div> <!-- /.section-content -->
                        </div>
                    </div> <!-- /.row -->
                </div> <!-- /.container-fluid -->
        ...
        <!--==  7. Afordable Pricing  ==-->
        <section id="menu-lists" class="menu-list">
            <div id="w">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Notre liste de menus à un prix abordable</h2>
        ...
        <section id="featured-dish" class="featured-dish">
            ...
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
                            <h2 class="section-title">Notre menu de plats en vedette</h2>
                        </div>
                        <div class="col-xs-6 col-sm-6 dis-table-cell section-bg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="opening-time">
                                    ...
                                    <p>Lun à jeu: 7:30 AM - 11:30 AM</p>
                                    <p>Sam & dim: 8:00 AM - 9:00 AM</p>
                                    ...
                                    <div class="dinner">
                                        <h4>Dinner</h4>
                                        <p>Lun to Sat: 6:00 PM - 1:00 AM</p>
                                        <p>Sam: 5:30 PM - 12:00 AM</p>
                                    </div>
                                </div>
                            </div>
                        </div>
