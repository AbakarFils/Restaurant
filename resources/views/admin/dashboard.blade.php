            ...
            <div class="row">
                    ...
                    <div class="card card-stats">
                        ...
                        <div class="card-footer">
                            <div class="stats">
                                ...
                                <a href="#pablo">Total Categories et Items</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            <p class="category"> Nombre Total de Slider </p>
                            <h3 class="title">{{ $sliderCount }}</h3>
                        </div>
                        <div class="card-footer">
                            <div class="stats">
                                <i class="material-icons">date_range</i> <a href="{{ route('slider.index') }}">Avoir plus de Details...</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-footer">
                            <div class="stats">
                                <i class="material-icons">local_offer</i>Réservation non confirmée
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            @if($reservation->status == true)
                                                <span class="label label-info">Confirmée</span>
                                            @else
                                                <span class="label label-danger">pas encore confirmé</span>
                                            @endif
